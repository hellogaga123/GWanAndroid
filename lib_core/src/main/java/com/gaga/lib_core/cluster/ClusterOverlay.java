...
//            addSingleClusterToMap(clusters.get(i), mClusterItems.get(i).getDrawableId());
//        }
    }
    ...
    private void addSingleClusterToMap(Cluster cluster) {
        Log.e("333333333", "calculateClusters: " + cluster.getClusterItems().size());
...
//                Log.e("333333333", "calculateClusters: ");
                if (cluster != null) {
    ...
    private BitmapDescriptor getBitmapDes(int num, Cluster cluster) {
        ...
        if (bitmapDescriptor == null) {
            ...
            if (num == 1) {
                textView.setBackgroundResource(cluster.getClusterItems().get(0).getDrawableId());
            } else {
